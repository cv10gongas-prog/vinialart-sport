import{n as e}from"./react-SIfiwpqq.js";var t=e((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),n=e(((e,n)=>{n.exports=t()}));function r(e){return`data:image/svg+xml;charset=UTF-8,${encodeURIComponent(e)}`}var i=`
  M400 45
...
`,u=(e,t)=>`
  <rect width="${e}" height="${t}" fill="url(#bg)"/>
  <rect y="${t*.62}" width="${e}" height="${t*.38}" fill="url(#floor)"/>
`,d=(e,t,n)=>`
  <ellipse cx="${e}" cy="${t}" rx="${n}" ry="${n*.16}" fill="#000000" opacity="0.62" filter="url(#soften)"/>
  <ellipse cx="${e}" cy="${t-4}" rx="${n*.6}" ry="${n*.09}" fill="#000000" opacity="0.8" filter="url(#softenSmall)"/>
`,f=`
  <g filter="url(#dropShadow)">
    <path d="${a}" fill="#20262f"/>
    <path d="${a}" fill="none" stroke="#3a4351" stroke-width="2"/>
    <path d="${i}" fill="url(#shell)"/>
    <path d="${i}" fill="url(#shellCurve)" opacity="0.85"/>
    <path d="${i}" fill="none" stroke="url(#rim)" stroke-width="3"/>
    <g clip-path="url(#shinClip)" opacity="0.5">
      <rect x="200" y="30" width="400" height="720" filter="url(#weave)"/>
    </g>
    <g clip-path="url(#shinClip)">
      <path d="${i}" fill="none" stroke="#ffffff" stroke-opacity="0.85" stroke-width="8" filter="url(#softenSmall)"/>
      <path d="${i}" fill="none" stroke="#7b8698" stroke-opacity="0.55" stroke-width="20" filter="url(#soften)"/>
...
`,p=`
  <defs>
    <clipPath id="shinClip"><path d="${i}"/></clipPath>
  </defs>
`,m=r(`
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800">
  <defs>
    <clipPath id="c"><path d="${i}"/></clipPath>
  ...
  <g clip-path="url(#c)">
    ...
    <path d="${i}" fill="none" stroke="#0d1218" stroke-opacity="0.45" stroke-width="14" filter="url(#b)"/>
  </g>
</svg>
`),g=r(`
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 900">
  ...
  ${d(380,828,180)}
  ${d(820,828,180)}
  <g transform="translate(380 440) rotate(-4) translate(-400 -390)">${f}</g>
  <g transform="translate(820 440) rotate(4) translate(-400 -390)">${f}</g>
</svg>
`),_=r(`
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800">
  ${l}
  <defs>
    <clipPath id="shinClipBack"><path d="${i}"/></clipPath>
  ...
  ${d(400,752,170)}
  <g filter="url(#dropShadow)">
    <path d="${a}" fill="#e6eaf1"/>
    <path d="${i}" fill="url(#backShade)"/>
    <g clip-path="url(#shinClipBack)">
      <path d="${i}" fill="none" stroke="#ffffff" stroke-opacity="0.18" stroke-width="10" filter="url(#softenSmall)"/>
    ...
    <path d="${i}" fill="none" stroke="#414c5c" stroke-width="3"/>
  </g>
</svg>
`);function v(e,t){return`
  <g filter="url(#dropShadow)">
    <path d="${e}" fill="url(#shell)"/>
    <path d="${e}" fill="url(#shellCurve)" opacity="0.7"/>
    ...
    <path d="${e}" fill="none" stroke="#c8d0dc" stroke-width="2" stroke-linejoin="round"/>
  ...
  `}var y=`
  <defs><clipPath id="jerseyClip"><path d="${o}"/></clipPath></defs>
`,b=`
  <defs><clipPath id="jerseyClip"><path d="${s}"/></clipPath></defs>
`,x=r(`
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800">
  ${l}
  ${y}
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800">
  <defs>
    <clipPath id="jerseyShadeClip"><path d="${o}"/></clipPath>
    <filter id="b" x="-40%" y="-40%" width="180%" height="180%">
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800">
  ${l}
  <defs>
    <clipPath id="flagClip"><path d="${c}"/></clipPath>
  ...
  <g filter="url(#dropShadow)">
    ...
    <path d="${c}" fill="none" stroke="#c8d0dc" stroke-width="2"/>
...
`);export{m as _,j as a,n as b,S as c,M as d,D as f,h as g,g as h,O as i,x as l,_ as m,o as n,T as o,A as p,i as r,w as s,s as t,C as u,k as v,E as y};