      ...
      <div className="mx-auto max-w-[1600px] px-5 pb-8 sm:px-8">
        <section>
          <div className="flex items-end justify-between gap-6 border-t border-border pt-8">
            <h2 className="text-2xl sm:text-3xl">Personalizáveis</h2>
        ...
        <section className="mt-24">
          <div className="flex items-end justify-between gap-6 border-t border-border pt-8">
            <h2 className="text-2xl sm:text-3xl">Serviços & pedidos</h2>
            <span className="text-[0.68rem] uppercase tracking-[0.22em] text-muted-foreground">
              Sob consulta
            </span>
          </div>
        ...
        <section className="mt-24 overflow-hidden rounded-3xl bg-surface/50 px-6 py-14 sm:px-12">
          <div className="flex flex-wrap items-center justify-between gap-8">
            <div className="max-w-xl">
              ...
              <p className="mt-4 text-sm text-muted-foreground sm:text-base">
                Falamos contigo para preparar a proposta gráfica do teu clube,
                claque ou grupo de atletas.
              </p>
            </div>
