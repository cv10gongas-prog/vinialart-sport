            ...
            >
              <div className="relative aspect-[4/5] overflow-hidden">
                <img
                  ...
                  loading="lazy"
                  className="h-full w-full object-contain p-8 pb-28 mix-blend-screen transition-transform duration-[900ms] ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-[1.04]"
                />
